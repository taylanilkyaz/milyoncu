...
-- milyoncu.aktivasyon_kodu: ~10 rows (yaklaşık) tablosu için veriler indiriliyor
...
INSERT IGNORE INTO `aktivasyon_kodu` (`id`, `aktivasyon_kodu`, `gönderim_zamanı`, `kullanıcı_id`) VALUES
	...
	(13, 735389, '0000-00-00 00:00:00', 0);
...
-- milyoncu.sipariş_durumu: ~1 rows (yaklaşık) tablosu için veriler indiriliyor
...
INSERT IGNORE INTO `sipariş_ilişkileri` (`id`, `sipariş_kodu`, `ekleme_zamanı`, `güncelleme_zamanı`, `sipariş_durumu`, `kullanıcı_id`, `kargo_adres_id`, `fatura_adres_id`, `kargo_numarası`, `kargo_sirketi`) VALUES
	(17, 'B1000001', '2017-12-31 21:59:52', '2017-12-31 22:06:24', 1, 7, 5, 5, NULL, 1),
	(18, 'B1000002', '2017-12-31 22:09:58', NULL, 0, 6, 2, 4, NULL, 4);
