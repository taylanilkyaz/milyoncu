(function( $, window, document, undefined ) {
    ...
    function fillProductTable(data) {
        ...
        $.each(data,function () {
            var str = '<tr><td>'+this.name+'</td>'+'<td>'+this.price+'</td>'+'<td>'+this.short_desc+'</td>'+
                    '<td>'+this.long_desc+'</td>'+
                '<td>'+'<img src="'+'/assets/images/productimage/'+this.image_path+'" alt="" border=3 height=50 width=50></img>'+'</td>'+
