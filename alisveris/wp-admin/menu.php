...
$menu[2] = array( __('Dashboard'), 'read', 'ajax.php', '', 'menu-top menu-top-first menu-icon-dashboard', 'menu-dashboard', 'dashicons-dashboard' );

$submenu[ 'ajax.php' ][0] = array( __('Home'), 'read', 'ajax.php' );

if ( is_multisite() ) {
	$submenu[ 'ajax.php' ][5] = array( __('My Sites'), 'read', 'my-sites.php' );
}
...
if ( ! is_multisite() ) {
	...
	elseif ( current_user_can( 'update_plugins' ) )
		...
		$cap = 'update_themes';
	$submenu[ 'ajax.php' ][10] = array( sprintf( __('Updates %s'), "<span class='update-plugins count-{$update_data['counts']['total']}'><span class='update-count'>" . number_format_i18n($update_data['counts']['total']) . "</span></span>" ), $cap, 'update-core.php');
	unset( $cap );
}
