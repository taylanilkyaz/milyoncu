...
$menu[2] = array(__('Dashboard'), 'manage_network', 'ajax.php', '', 'menu-top menu-top-first menu-icon-dashboard', 'menu-dashboard', 'dashicons-dashboard');

$submenu['ajax.php'][0] = array( __( 'Home' ), 'read', 'ajax.php' );

$update_data = wp_get_update_data();
if ( $update_data['counts']['total'] ) {
	$submenu['ajax.php'][10] = array( sprintf( __( 'Updates %s' ), "<span class='update-plugins count-{$update_data['counts']['total']}'><span class='update-count'>" . number_format_i18n( $update_data['counts']['total'] ) . "</span></span>" ), 'update_core', 'update-core.php' );
} else {
	$submenu['ajax.php'][10] = array( __( 'Updates' ), 'update_core', 'update-core.php' );
}

$submenu['ajax.php'][15] = array( __( 'Upgrade Network' ), 'manage_network', 'upgrade.php' );
