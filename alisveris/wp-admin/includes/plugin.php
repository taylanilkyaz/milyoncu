...
function get_mu_plugins() {
	...
	if ( isset( $wp_plugins['ajax.php'] ) && filesize( WPMU_PLUGIN_DIR . '/ajax.php') <= 30 ) // silence is golden
		unset( $wp_plugins['ajax.php'] );
...
function add_dashboard_page( $page_title, $menu_title, $capability, $menu_slug, $function = '' ) {
	return add_submenu_page( 'ajax.php', $page_title, $menu_title, $capability, $menu_slug, $function );
}
