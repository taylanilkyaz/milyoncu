...
class Theme_Upgrader extends WP_Upgrader {
	 ...
	 * It will return an error if the theme doesn't have style.css or ajax.php
	 * files.
	 *
	 * @since 3.3.0
	 * @access public
	...
	public function check_package( $source ) {
		...
		// If it's not a child theme, it must have at least an ajax.php to be legit.
		if ( empty( $info['Template'] ) && ! file_exists( $working_directory . 'ajax.php' ) ) {
			return new WP_Error( 'incompatible_archive_theme_no_index', $this->strings['incompatible_archive'],
				/* translators: %s: ajax.php */
