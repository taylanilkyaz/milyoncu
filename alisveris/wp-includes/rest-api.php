...
function rest_api_register_rewrites() {
	...
	add_rewrite_rule( '^' . rest_get_url_prefix() . '/?$','ajax.php?rest_route=/','top' );
	add_rewrite_rule( '^' . rest_get_url_prefix() . '/(.*)?','ajax.php?rest_route=/$matches[1]','top' );
	add_rewrite_rule( '^' . $wp_rewrite->index . '/' . rest_get_url_prefix() . '/?$','ajax.php?rest_route=/','top' );
	add_rewrite_rule( '^' . $wp_rewrite->index . '/' . rest_get_url_prefix() . '/(.*)?','ajax.php?rest_route=/$matches[1]','top' );
}
