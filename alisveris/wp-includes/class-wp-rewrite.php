...
class WP_Rewrite {
	...
	/**
	 * Rules that don't redirect to WordPress' ajax.php.
	 *
	 ...
	 *
	 * Means that permalink links are enabled and ajax.php is in the URL.
	 *
	 * @since 1.5.0
	 * @access public
	 *
	 * @return bool Whether permalink links are enabled and ajax.php is in the URL.
	 */
	 ...
	 *
	 * Using permalinks and ajax.php is not in the URL.
	 *
	 * @since 1.5.0
	 * @access public
	 *
	 * @return bool Whether permalink links are enabled and ajax.php is NOT in the URL.
	 */
	...
	public function generate_rewrite_rules($permalink_structure, $ep_mask = EP_NONE, $paged = true, $feed = true, $forcomments = false, $walk_dirs = true, $endpoints = true) {
		...
		$index = $this->index; //probably 'ajax.php'
		$feedindex = $index;
	...
	public function mod_rewrite_rules() {
		...
		// Prevent -f checks on ajax.php.
		$rules .= "RewriteRule ^index\.php$ - [L]\n";

		// Add in the rules that don't redirect to WP's ajax.php (and thus shouldn't be handled by WP at all).
	...
	public function add_rule( $regex, $query, $after = 'bottom' ) {
		if ( is_array( $query ) ) {
			$external = false;
			$query = add_query_arg( $query, 'ajax.php' );
		} else {
		...
		// "external" = it doesn't correspond to ajax.php.
		if ( $external ) {
	...
	/**
	 * Adds a rewrite rule that doesn't correspond to ajax.php.
	 *
	 * @since 2.1.0
	 * @access public
	 *
