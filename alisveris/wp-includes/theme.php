...
/**
 * Checks that current theme files 'ajax.php' and 'style.css' exists.
 *
...
function validate_current_theme() {
	...
	if ( ! file_exists( get_template_directory() . '/ajax.php' ) ) {
		// Invalid.
...
function get_theme_starter_content() {
	...
	$core_content = array(
		...
		'posts' => array(
			...
			'Contact.class' => array(
				'post_type' => 'page',
				'post_title' => _x( 'Contact.class', 'Theme starter content' ),
