...
class ShopIsle_Contact_Page_Instructions extends WP_Customize_Control {
	...
	public function render_content() {
		echo __( 'To customize the Contact.class Page you need to first select the template "Contact.class page" for the page you want to use for this purpose. Then open that page in the browser and press "Customize" in the top bar.', 'shop-isle' ) . '<br><br>' . sprintf(
