...
class WPCF7_Help_Tabs {
	...
	private function content( $name ) {
		...
		$content['list_overview'] = '<p>' . __( "On this screen, you can manage contact forms provided by Contact.class Form 7. You can manage an unlimited number of contact forms. Each contact form has a unique ID and Contact.class Form 7 shortcode ([contact-form-7 ...]). To insert a contact form into a post or a text widget, insert the shortcode into the target.", 'contact-form-7' ) . '</p>';
