...
function wpcf7_admin_menu() {
	...
	add_menu_page( __( 'Contact.class Form 7', 'contact-form-7' ),
		__( 'Contact.class', 'contact-form-7' ),
		'wpcf7_read_contact_forms', 'wpcf7',
		'wpcf7_admin_management_page', 'dashicons-email',
		$_wp_last_object_menu );

	$edit = add_submenu_page( 'wpcf7',
		__( 'Edit Contact.class Form', 'contact-form-7' ),
		__( 'Contact.class Forms', 'contact-form-7' ),
		'wpcf7_read_contact_forms', 'wpcf7',
	...
	$addnew = add_submenu_page( 'wpcf7',
		__( 'Add New Contact.class Form', 'contact-form-7' ),
...
<h1 class="wp-heading-inline"><?php
	echo esc_html( __( 'Contact.class Forms', 'contact-form-7' ) );
?></h1>
...
<form method="get" action="">
	...
	<?php $list_table->search_box( __( 'Search Contact.class Forms', 'contact-form-7' ), 'wpcf7-contact' ); ?>
...
function wpcf7_admin_bulk_validate_page() {
	...
	$submit_text = sprintf(
		_n(
			"Validate %s Contact.class Form Now",
			"Validate %s Contact.class Forms Now",
...
function wpcf7_admin_updated_message() {
	...
	if ( 'created' == $_REQUEST['message'] ) {
		$updated_message = __( "Contact.class form created.", 'contact-form-7' );
	} elseif ( 'saved' == $_REQUEST['message'] ) {
		$updated_message = __( "Contact.class form saved.", 'contact-form-7' );
	} elseif ( 'deleted' == $_REQUEST['message'] ) {
		$updated_message = __( "Contact.class form deleted.", 'contact-form-7' );
	}
...
<p><?php echo sprintf( __( '<strong>Contact.class Form 7 %1$s requires WordPress %2$s or higher.</strong> Please <a href="%3$s">update WordPress</a> first.', 'contact-form-7' ), WPCF7_VERSION, WPCF7_REQUIRED_WP_VERSION, admin_url( 'update-core.php' ) ); ?></p>
</div>
<?php
}
...
function wpcf7_notice_bulk_validate_config() {
	...
	$link = sprintf( '<a href="%s">%s</a>', $link, esc_html( __( 'Validate Contact.class Form 7 Configuration', 'contact-form-7' ) ) );
