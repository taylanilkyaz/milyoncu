<div id="buy-container">
    ...
    <h1 class="ui center aligned header"><?php echo $smallval;?> TL ve <?php echo $largeval;?> TL Arasındaki Ürünler</h1>
    ...
    <div class="ui four column doubling stackable centered grid">
        ...
        <h1 class="ui center aligned header"><?php echo ucwords($searchkey);?>  Arama Sonucu</h1>
        <div class="ui divider"></div>
        <div class="ui four column doubling stackable centered grid">
            <?php
            /**
             ...
             */
            $buy = new Buy();
            $products = $buy->getAllProductsSearch($searchkey);
            $i = 0;
            foreach ($products as $product) {?>
