...
HTML;
    ...
    {
        $res = $this->getProductDb()->getMaxThree();
        if (!$res) {
            $this->is_error = true;
            $this->error_message = $this->getDb()->getErrorMessage();
        }
    ...
    {
        $res = $this->getProductDb()->getMinThree();
        if (!$res) {
            $this->is_error = true;
            $this->error_message = $this->getDb()->getErrorMessage();
        }
    ...
    {
        $res = $this->getProductDb()->getSoldMost();
        if (!$res) {
            $this->is_error = true;
            $this->error_message = $this->getDb()->getErrorMessage();
        }
    ...
    {
        $res = $this->getProductDb()->getMeanPrice();
        if (!$res) {
            $this->is_error = true;
            $this->error_message = $this->getDb()->getErrorMessage();
        }
    ...
    {
        $res = $this->getProductDb()->getProductCount();
        if (!$res) {
            $this->is_error = true;
            $this->error_message = $this->getDb()->getErrorMessage();
        }
    ...
    {
        $res = $this->getProductDb()->getMostCargo();
        if (!$res) {
            $this->is_error = true;
            $this->error_message = $this->getDb()->getErrorMessage();
        }
