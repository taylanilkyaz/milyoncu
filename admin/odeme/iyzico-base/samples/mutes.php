 ...
 * Bir Taksit fiyatı
 */
$instalmentPrice = $installmentPrices[0]->installmentPrice;

/**
 * Taksitli Toplam Fiyat
 */
$instalmentPrice = $installmentPrices[0]->totalPrice;

/**
 * Taksit Sayısı
 */
$instalmentNumber = $installmentPrices[0]->installmentNumber;
...
print_r($installmentInfo->getStatus());
/**
 * 1 0
 */
print_r($installmentDetail->getForce3ds());


/**
 * Garanti
 */
print_r($installmentDetail->getBankName());

/**
 * Master Card
 */
print_r($installmentDetail->getCardAssociation());

/**
 * Bonus
 */
print_r($installmentDetail->getCardFamilyName());
