                    ...
                    if ($bool) {
                        ...
                        <div id="segment-id" class="ui segment">
                            <div id="top-content-2" class="ui fluid container">
                                ...
                                <div class="two fields" style="margin-bottom: 60px">
                                    <div class="field">
                                        ...
                                        <div class="ui selection dropdown" id="cargo-dropdown">
                                            ...
                                            <div class="menu" id="cargo-menu">
                                                ...
                                                for ($i = 0; $i < count($all_cargo_address); $i++) {
                                                    ...
                                                    ?>
                                                    <div class="item"
                                                         data-value="<?php echo $one_cargo_address['kargo_adresi_id']; ?>"><?php
                                        ...
                                        <div class="ui selection dropdown" id="bill-dropdown">
                                            ...
                                            <div class="menu" id="bill-menu">
                                                ...
                                                for ($i = 0; $i < count($all_bill_address); $i++) {
                                                    ...
                                                    ?>
                                                    <div class="item"
                                                         data-value="<?php echo $one_bill_address['fatura_adresi_id']; ?>"><?php
                        ...
                        <div id="segment-id" class="ui segment">
                            <div class="content">
                                ...
                                <div class="inline fields">
                                    <div class="sixteen wide field">
                                        ...
                                        <div class="ui fluid search selection dropdown" id="country-selector">
                                            ...
                                            <div class="menu">
                                                <div class="item" data-value="Afganistan"><i class="af flag"></i>Afganistan
                                                </div>
                                                <div class="item" data-value="Aland Adaları"><i class="ax flag"></i>Aland
                                                    Adaları
                                                </div>
                                                <div class="item" data-value="Arnavutluk"><i class="al flag"></i>Arnavutluk
                                                </div>
                                                <div class="item" data-value="Cezayir"><i class="dz flag"></i>Cezayir
                                                </div>
                                                <div class="item" data-value="Amerikan Samoası"><i class="as flag"></i>Amerikan
                                                    Samoası
                                                </div>
                                                <div class="item" data-value="Andora"><i class="ad flag"></i>Andora
                                                </div>
                                                <div class="item" data-value="Angola"><i class="ao flag"></i>Angola
                                                </div>
                                                <div class="item" data-value="Anguilla"><i class="ai flag"></i>Anguilla
                                                </div>
                                                <div class="item" data-value="Antigua"><i class="ag flag"></i>Antigua
                                                </div>
                                                <div class="item" data-value="Arjantin"><i class="ar flag"></i>Arjantin
                                                </div>
                                                <div class="item" data-value="Ermenistan"><i class="am flag"></i>Ermenistan
                                                </div>
                                                <div class="item" data-value="Aruba"><i class="aw flag"></i>Aruba</div>
                                                <div class="item" data-value="Avustralya"><i class="au flag"></i>Avustralya
                                                </div>
                                                <div class="item" data-value="Avusturya"><i class="at flag"></i>Avusturya
                                                </div>
                                                <div class="item" data-value="Azerbeycan"><i class="az flag"></i>Azerbeycan
                                                </div>
                                                <div class="item" data-value="Bahamalar"><i class="bs flag"></i>Bahamalar
                                                </div>
                                                <div class="item" data-value="Bahreyn"><i class="bh flag"></i>Bahreyn
                                                </div>
                                                <div class="item" data-value="Bangladeş"><i class="bd flag"></i>Bangladeş
                                                </div>
                                                <div class="item" data-value="Barbados"><i class="bb flag"></i>Barbados
                                                </div>
                                                <div class="item" data-value="Belarus"><i class="by flag"></i>Belarus(Beyaz
                                                    Rusya)
                                                </div>
                                                <div class="item" data-value="Belçika"><i class="be flag"></i>Belçika
                                                </div>
                                                <div class="item" data-value="Belize"><i class="bz flag"></i>Belize
                                                </div>
                                                <div class="item" data-value="Benin"><i class="bj flag"></i>Benin</div>
                                                <div class="item" data-value="Bermuda"><i class="bm flag"></i>Bermuda
                                                </div>
                                                <div class="item" data-value="Butan"><i class="bt flag"></i>Butan</div>
                                                <div class="item" data-value="Bolivya"><i class="bo flag"></i>Bolivya
                                                </div>
                                                <div class="item" data-value="Bosna"><i class="ba flag"></i>Bosna</div>
                                                <div class="item" data-value="Botsvana"><i class="bw flag"></i>Botsvana
                                                </div>
                                                <div class="item" data-value="Buvet Adaları"><i class="bv flag"></i>Buvet
                                                    Adaları
                                                </div>
                                                <div class="item" data-value="Brezilya"><i class="br flag"></i>Brezilya
                                                </div>
                                                <div class="item" data-value="Bulgaristan"><i class="bg flag"></i>Bulgaristan
                                                </div>
                                                <div class="item" data-value="Kamboçya"><i class="kh flag"></i>Kamboçya
                                                </div>
                                                <div class="item" data-value="Kamerun"><i class="cm flag"></i>Kamerun
                                                </div>
                                                <div class="item" data-value="Kanada"><i class="ca flag"></i>Kanada
                                                </div>
                                                ...
                                                <div class="item" data-value="Noel Adası"><i class="cx flag"></i>Noel
                                                    Adası
                                                </div>
                                                <div class="item" data-value="Kolombiya"><i class="co flag"></i>Kolombiya
                                                </div>
                                                <div class="item" data-value="Komoros"><i class="km flag"></i>Komoros
                                                </div>
                                                <div class="item" data-value="Kongo"><i class="cd flag"></i>Kongo</div>
                                                <div class="item" data-value="Kosta Rika"><i class="cr flag"></i>Kosta
                                                    Rika
                                                </div>
                                                <div class="item" data-value="Fildişi Sahili"><i class="ci flag"></i>Fildişi
                                                    Sahili
                                                </div>
                                                <div class="item" data-value="Hırvatistan"><i class="hr flag"></i>Hırvatistan
                                                </div>
                                                ...
                                                <div class="item" data-value="Danimarka"><i class="dk flag"></i>Danimarka
                                                </div>
                                                <div class="item" data-value="Cibuti"><i class="dj flag"></i>Cibuti
                                                </div>
                                                <div class="item" data-value="Dominica"><i class="dm flag"></i>Dominica
                                                </div>
                                                <div class="item" data-value="Dominik Cumhuriyeti"><i
                                                            class="do flag"></i>Dominik Cumhuriyeti
                                                </div>
                                                <div class="item" data-value="Elvador"><i class="ec flag"></i>Elvador
                                                </div>
                                                <div class="item" data-value="Mısır"><i class="eg flag"></i>Mısır</div>
                                                <div class="item" data-value="El Salvador"><i class="sv flag"></i>El
                                                    Salvador
                                                </div>
                                                <div class="item" data-value="İngiltere"><i class="gb flag"></i>İngiltere
                                                </div>
                                                <div class="item" data-value="Ekvator Ginesi"><i class="gq flag"></i>Ekvator
                                                    Ginesi
                                                </div>
                                                <div class="item" data-value="Eritre"><i class="er flag"></i>Eritre
                                                </div>
                                                <div class="item" data-value="Estonya"><i class="ee flag"></i>Estonya
                                                </div>
                                                <div class="item" data-value="Etyopya"><i class="et flag"></i>Etyopya
                                                </div>
                                                <div class="item" data-value="Avrupa Birliği"><i class="eu flag"></i>Avrupa
                                                    Birliği
                                                </div>
                                                <div class="item" data-value="Finlandiya"><i class="fi flag"></i>Finlandiya
                                                </div>
                                                <div class="item" data-value="fr"><i class="fr flag"></i>Fransa</div>
                                                <div class="item" data-value="Fransız Guyanası"><i class="gf flag"></i>Fransız
                                                    Guyanası
                                                </div>
                                                <div class="item" data-value="Gürcistan"><i class="ge flag"></i>Gürcistan
                                                </div>
                                                <div class="item" data-value="Almanya"><i class="de flag"></i>Almanya
                                                </div>
                                                <div class="item" data-value="Gana"><i class="gh flag"></i>Gana</div>
                                                <div class="item" data-value="Cebelitarık"><i class="gi flag"></i>Cebelitarık
                                                </div>
                                                <div class="item" data-value="Yunanistan"><i class="gr flag"></i>Yunanistan
                                                </div>
                                                <div class="item" data-value="Grönland"><i class="gl flag"></i>Grönland
                                                </div>
                                                <div class="item" data-value="Gine"><i class="gn flag"></i>Gine</div>
                                                <div class="item" data-value="Haiti"><i class="ht flag"></i>Haiti</div>
                                                <div class="item" data-value="Honduras"><i class="hn flag"></i>Honduras
                                                </div>
                                                <div class="item" data-value="Hong Kong"><i class="hk flag"></i>Hong
                                                    Kong
                                                </div>
                                                <div class="item" data-value="Macaristan"><i class="hu flag"></i>Macaristan
                                                </div>
                                                <div class="item" data-value="İzlanda"><i class="is flag"></i>İzlanda
                                                </div>
                                                <div class="item" data-value="Hindistan"><i class="in flag"></i>Hindistan
                                                </div>
                                                <div class="item" data-value="Endonezya"><i class="id flag"></i>Endonezya
                                                </div>
                                                <div class="item" data-value="İran"><i class="ir flag"></i>İran</div>
                                                <div class="item" data-value="Irak"><i class="iq flag"></i>Irak</div>
                                                <div class="item" data-value="İrlanda"><i class="ie flag"></i>İrlanda
                                                </div>
                                                <div class="item" data-value="İsrail"><i class="il flag"></i>İsrail
                                                </div>
                                                <div class="item" data-value="İtalya"><i class="it flag"></i>İtalya
                                                </div>
                                                <div class="item" data-value="Jameyika"><i class="jm flag"></i>Jameyika
                                                </div>
                                                <div class="item" data-value="Japonya"><i class="jp flag"></i>Japonya
                                                </div>
                                                <div class="item" data-value="Ürdün"><i class="jo flag"></i>Ürdün</div>
                                                <div class="item" data-value="Kazakistan"><i class="kz flag"></i>Kazakistan
                                                </div>
                                                <div class="item" data-value="Kenya"><i class="ke flag"></i>Kenya</div>
                                                <div class="item" data-value="Kiribati"><i class="ki flag"></i>Kiribati
                                                </div>
                                                <div class="item" data-value="Kuveyt"><i class="kw flag"></i>Kuveyt
                                                </div>
                                                <div class="item" data-value="Kırgızistan"><i class="kg flag"></i>Kırgızistan
                                                </div>
                                                <div class="item" data-value="Laos"><i class="la flag"></i>Laos</div>
                                                <div class="item" data-value="Letonya"><i class="lv flag"></i>Letonya
                                                </div>
                                                <div class="item" data-value="Lübnan"><i class="lb flag"></i>Lübnan
                                                </div>
                                                <div class="item" data-value="Lesotho"><i class="ls flag"></i>Lesotho
                                                </div>
                                                <div class="item" data-value="Liberya"><i class="lr flag"></i>Liberya
                                                </div>
                                                <div class="item" data-value="Libya"><i class="ly flag"></i>Libya</div>
                                                <div class="item" data-value="Lichtenstein"><i class="li flag"></i>Lichtenstein
                                                </div>
                                                <div class="item" data-value="Litvanya"><i class="lt flag"></i>Litvanya
                                                </div>
                                                <div class="item" data-value="Luxembourg"><i class="lu flag"></i>Luxembourg
                                                </div>
                                                <div class="item" data-value="Makedonya"><i class="mk flag"></i>Makedonya
                                                </div>
                                                <div class="item" data-value="Maldivler"><i class="mv flag"></i>Maldivler
                                                </div>
                                                ...
                                                <div class="item" data-value="an"><i class="an flag"></i>Hollanda
                                                    Antilleri
                                                </div>
                                                ...
                                                <div class="item" data-value="nz"><i class="nz flag"></i>Yeni Zellanda
                                                </div>
                                                ...
                                                <div class="item" data-value="kp"><i class="kp flag"></i>Kuzey Kore
                                                </div>
                                                ...
                                                <div class="item" data-value="ph"><i class="ph flag"></i>Filipinler
                                                </div>
                                                ...
                                                <div class="item" data-value="pr"><i class="pr flag"></i>Porto Rico
                                                </div>
                                                ...
                                                <div class="item" data-value="za"><i class="za flag"></i>Güney Afrika
                                                </div>
                                                <div class="item" data-value="kr"><i class="kr flag"></i>Güney Kore
                                                </div>
                                                ...
                                                <div class="item" data-value="tm"><i class="tm flag"></i>Türkmenistan
                                                </div>
                                                ...
                                                <div class="item" data-value="us"><i class="us flag"></i>Amerika
                                                    Birleşik
                                                    Devletleri
                                                </div>
                                                ...
                                                <div class="item" data-value="uz"><i class="uz flag"></i>Özbekistan
                                                </div>
                                                ...
                                                <div class="item" data-value="eh"><i class="eh flag"></i>Batı Sahra
                                                </div>
                                ...
                                <h4 id="contact-information-header-id" class="ui dividing header">İletişim
                                    Bilgileri</h4>
                        ...
                        <div id="modal-segment-id" class="ui segment">
                            <div class="content">
                                ...
                                <div class="inline fields">
                                    <div class="sixteen wide field">
                                        <label>Adres Adı</label>
                                        <input name="billAddressName" type="text" placeholder="Adres Adı"
                                               maxlength="51">
                                    </div>
                                </div>
                                ...
                                <div class="inline fields">
                                    <div class="sixteen wide field">
                                        ...
                                        <div class="ui fluid search selection dropdown" id="country-selector-2">
                                            ...
                                            <div class="menu">
                                                <div class="item" data-value="af"><i class="af flag"></i>Afganistan
                                                </div>
                                                <div class="item" data-value="ax"><i class="ax flag"></i>Aland Adaları
                                                </div>
                                                <div class="item" data-value="al"><i class="al flag"></i>Arnavutluk
                                                </div>
                                                <div class="item" data-value="dz"><i class="dz flag"></i>Cezayir</div>
                                                <div class="item" data-value="as"><i class="as flag"></i>Amerikan
                                                    Samoası
                                                </div>
                                                ...
                                                <div class="item" data-value="am"><i class="am flag"></i>Ermenistan
                                                </div>
                                                <div class="item" data-value="aw"><i class="aw flag"></i>Aruba</div>
                                                <div class="item" data-value="au"><i class="au flag"></i>Avustralya
                                                </div>
                                                <div class="item" data-value="at"><i class="at flag"></i>Avusturya</div>
                                                <div class="item" data-value="az"><i class="az flag"></i>Azerbeycan
                                                </div>
                                                ...
                                                <div class="item" data-value="bv"><i class="bv flag"></i>Buvet Adaları
                                                </div>
                                                ...
                                                <div class="item" data-value="bg"><i class="bg flag"></i>Bulgaristan
                                                </div>
                                                ...
                                                <div class="item" data-value="cx"><i class="cx flag"></i>Noel Adası
                                                </div>
                                                <div class="item" data-value="cc"><i class="cc flag"></i>Cocos Adaları
                                                </div>
                                                <div class="item" data-value="co"><i class="co flag"></i>Kolombiya</div>
                                                <div class="item" data-value="km"><i class="km flag"></i>Komoros</div>
                                                <div class="item" data-value="cg"><i class="cg flag"></i>Kongo
                                                    Brazzaville
                                                </div>
                                                <div class="item" data-value="cd"><i class="cd flag"></i>Kongo</div>
                                                <div class="item" data-value="ck"><i class="ck flag"></i>Cook Adaları
                                                </div>
                                                <div class="item" data-value="cr"><i class="cr flag"></i>Kosta Rika
                                                </div>
                                                <div class="item" data-value="ci"><i class="ci flag"></i>Fildişi Sahili
                                                </div>
                                                <div class="item" data-value="hr"><i class="hr flag"></i>Hırvatistan
                                                </div>
                                                <div class="item" data-value="cu"><i class="cu flag"></i>Kuba</div>
                                                <div class="item" data-value="cy"><i class="cy flag"></i>Güney Kıbrıs
                                                    Rum
                                                    Cumhuriyeti
                                                </div>
                                                ...
                                                <div class="item" data-value="do"><i class="do flag"></i>Dominik
                                                    Cumhuriyeti
                                                </div>
                                                ...
                                                <div class="item" data-value="fo"><i class="fo flag"></i>Faroe Adaları
                                                </div>
                                                <div class="item" data-value="fj"><i class="fj flag"></i>Fiji</div>
                                                <div class="item" data-value="fi"><i class="fi flag"></i>Finlandiya
                                                </div>
                                                <div class="item" data-value="fr"><i class="fr flag"></i>Fransa</div>
                                                <div class="item" data-value="gf"><i class="gf flag"></i>Fransız
                                                    Guyanası
                                                </div>
                                                <div class="item" data-value="pf"><i class="pf flag"></i>Fransız
                                                    Polinezyası
                                                </div>
                                                <div class="item" data-value="tf"><i class="tf flag"></i>Fransız
                                                    Bölgeleri
                                                </div>
                                                ...
                                                <div class="item" data-value="gi"><i class="gi flag"></i>Cebelitarık
                                                </div>
                                                <div class="item" data-value="gr"><i class="gr flag"></i>Yunanistan
                                                </div>
                                                ...
                                                <div class="item" data-value="kz"><i class="kz flag"></i>Kazakistan
                                                </div>
                                                ...
                                                <div class="item" data-value="kg"><i class="kg flag"></i>Kırgızistan
                                                </div>
                                                ...
                                                <div class="item" data-value="li"><i class="li flag"></i>Lichtenstein
                                                </div>
                                                ...
                                                <div class="item" data-value="mg"><i class="mg flag"></i>Madagaskar
                                                </div>
                        ...
                        <div id="cargo-modal-segment-id" class="ui segment">
                            <div class="content">
                                ...
                                <div class="inline fields">
                                    <div class="sixteen wide field">
                                        <label>Adres Adı</label>
                                        <input name="cargoAddressName" type="text" placeholder="Adres Adı"
                                               maxlength="51">
                                    </div>
                                </div>
